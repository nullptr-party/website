...
const playlistUrl = 'https://www.youtube.com/playlist?list=PL1rdjlpSaYF3Tz3NZx-8HdpViWOcOOBVC';
              ...
              >
                ...
                {speaker.video && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 font-pixel text-[9px] sm:text-[10px] text-[#FFD700] bg-[#FFD700]/10 border border-[#FFD700]/30 hover:bg-[#FFD700]/20 transition-colors mt-3 ml-3 px-3 py-1.5 uppercase tracking-wider"
                  >
